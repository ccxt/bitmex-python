...
- `amount_to_precision(self, symbol: Str, amount: Any)`
...
- `convert_from_raw_cost(self, symbol: Any, rawQuantity: Any)`
- `convert_from_raw_quantity(self, symbol: Any, rawQuantity: Any, currencySide='base')`
- `convert_from_real_amount(self, code: Any, amount: Any)`
